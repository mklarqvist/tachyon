...
std::ofstream& operator<<(std::ofstream& stream, const DataBlockFooter& entry){
...
std::ifstream& operator>>(std::ifstream& stream, DataBlockFooter& entry){
...
io::BasicBuffer& operator+=(io::BasicBuffer& buffer, const DataBlockFooter& entry){
