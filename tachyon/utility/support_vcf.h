...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<BYTE>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<U16>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<U32>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<U64>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<SBYTE>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<S16>& container){
	if(container.size() == 0)
		return(stream);
...
inline std::ostream& to_vcf_string(std::ostream& stream, containers::PrimitiveContainer<S32>& container){
	if(container.size() == 0)
		return(stream);
...
// Special case
inline std::ostream& to_vcf_string_char(std::ostream& stream, containers::PrimitiveContainer<char>& container){
	if(container.size() == 0)
		return(stream);
