...
public:
	PermutationManager() : stride_size(sizeof(U32)), n_samples(0), c_length(0), crc(0){}
	PermutationManager(const U32 n_samples) : stride_size(sizeof(U32)), n_samples(n_samples), c_length(0), crc(0), PPA(sizeof(U32)*n_samples){}
