...
const int32_t TACHYON_VERSION_MINOR = 3;
const int32_t TACHYON_VERSION_PATCH = 1;
...
const uint32_t FILE_HEADER_LENGTH    = 8;
...
const uint8_t REF_ALT_G = 2;
const uint8_t REF_ALT_C = 3;
const uint8_t REF_ALT_MISSING = 4;
const uint8_t REF_ALT_NON_REF = 5;
const uint8_t REF_ALT_N = 6;


//                                     A  T  G  C  N
const uint8_t TRANSITION_MAP_BASE_A[5] = {0, 0, 1, 0, 0}; // A->G
const uint8_t TRANSITION_MAP_BASE_T[5] = {0, 0, 0, 1, 0}; // T->C
const uint8_t TRANSITION_MAP_BASE_G[5] = {1, 0, 0, 0, 0}; // G->A
const uint8_t TRANSITION_MAP_BASE_C[5] = {0, 1, 0, 0, 0}; // C->T
const uint8_t TRANSITION_MAP_BASE_N[5] = {0, 0, 0, 0, 0}; // None
const uint8_t* const TRANSITION_MAP[9] =
...
//                                       A  T  G  C  N
const uint8_t TRANSVERSION_MAP_BASE_A[5] = {0, 1, 0, 1, 0};
const uint8_t TRANSVERSION_MAP_BASE_T[5] = {1, 0, 1, 0, 0};
const uint8_t TRANSVERSION_MAP_BASE_G[5] = {0, 1, 0, 1, 0};
const uint8_t TRANSVERSION_MAP_BASE_C[5] = {1, 0, 1, 0, 0};
const uint8_t TRANSVERSION_MAP_BASE_N[5] = {0, 0, 0, 0, 0};
const uint8_t* const TRANSVERSION_MAP[9] =
...
const uint8_t TACHYON_FILE_EOF_LENGTH = 32;
