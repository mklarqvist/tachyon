...
const S32 TACHYON_VERSION_MINOR = 3;
const S32 TACHYON_VERSION_PATCH = 0;
const S32 TACHYON_VERSION_NUMBER   = (TACHYON_VERSION_MAJOR *100*100 + TACHYON_VERSION_MINOR *100 + TACHYON_VERSION_PATCH);
