	...
	footer_support(other.footer_support)
{
	...
	for(U32 i = 0; i < this->footer.n_info_streams; ++i)   this->info_containers[i]   = other.info_containers[i];
	for(U32 i = 0; i < this->footer.n_format_streams; ++i) this->format_containers[i] = other.format_containers[i];
}
