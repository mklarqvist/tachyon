...
yon_buffer_t::yon_buffer_t(const uint64_t size) :
	owns_data_(true),
	n_chars_(0),
	width_(size),
	iterator_position_(0),
...
yon_buffer_t::yon_buffer_t(char* target, const size_t length) :
	owns_data_(false),
	n_chars_(length),
	width_(length),
	iterator_position_(0),
...
yon_buffer_t::yon_buffer_t(const uint64_t size, char* target) :
	owns_data_(false),
	n_chars_(0),
	width_(size),
	iterator_position_(0),
...
yon_buffer_t::yon_buffer_t(const self_type& other) :
